...
<body>
	...
	<div id="Popup">
		...
		<div id="SubPopup">
			...
			<form action="${ctx}/book/update?bookid=${bookid}" method="post">
				<div class="form_boxC">
					<c:forEach items="${list}" var="book">
						<h2>修改图书:${book.book_name }</h2>
							...
							<tr>
								...
								<td>
									...
									<div class="txtbox floatL" style="width: 100px;">
										<input name="auther" type="text" size="5" value="${book.book_auther }">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="txtbox " style="width: 230px;">
										<input name="publisher" type="text" size="20" value="${book.book_publisher }">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="txtbox floatL" style="width: 230px;">
										<input name="date" type="text" size="20" value="${book.book_publish_date }">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="txtbox floatL" style="width: 230px;">
										<input name="price" type="text" value="${book.book_price }" />
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="txtbox floatL" style="width: 230px;">
										<input name="typeid" type="text" size="10" value="${book.booktype.type_id }">
									</div>
								</td>
							</tr>
						</table>
